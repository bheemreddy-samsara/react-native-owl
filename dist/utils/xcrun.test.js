...
describe('xcrun.ts', () => {
    ...
    describe('xcrunStatusBar', () => {
        it('updates the status bar with default config', async () => {
            ...
            expect(execMock).toHaveBeenNthCalledWith(1, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'ignore', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl status_bar iPhone\\ 13\\ Pro override --time 9:41', {
        ...
        it('updates the status bar with debug', async () => {
            ...
            expect(execMock).toHaveBeenCalledTimes(2);
            expect(execMock).toHaveBeenNthCalledWith(1, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'inherit', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl status_bar iPhone\\ 13\\ Pro override --time 9:41', {
                cwd: '/Users/johndoe/Projects/my-project/ios/build/Build/Products/Debug-iphonesimulator',
                stdio: 'inherit',
            });
    ...
    describe('xcrunInstall', () => {
        it('installs the app with default config', async () => {
            ...
            expect(execMock).toHaveBeenCalledTimes(2);
            expect(execMock).toHaveBeenNthCalledWith(1, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'ignore', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl install iPhone\\ 13\\ Pro MyApp.app', {
                cwd: '/Users/johndoe/Projects/my-project/ios/build/Build/Products/Debug-iphonesimulator',
                stdio: 'ignore',
            });
        });
        ...
        it('installs the app with custom binaryPath', async () => {
            ...
            expect(execMock).toHaveBeenCalledTimes(2);
            expect(execMock).toHaveBeenNthCalledWith(1, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'ignore', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl install iPhone\\ 13\\ Pro app.app', {
                cwd: '/some/path/to/my',
                stdio: 'ignore',
            });
        });
    ...
    describe('xcrunTerminate', () => {
        it('terminates the app with default config', async () => {
            ...
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'ignore', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(3, 'xcrun simctl terminate iPhone\\ 13\\ Pro bundleId', {
                cwd: '/Users/johndoe/Projects/my-project/ios/build/Build/Products/Debug-iphonesimulator',
                stdio: 'ignore',
            });
        });
        it('terminates the app with debug', async () => {
            ...
            expect(execMock).toHaveBeenCalledTimes(3);
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'inherit', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(3, 'xcrun simctl terminate iPhone\\ 13\\ Pro bundleId', {
                cwd: '/Users/johndoe/Projects/my-project/ios/build/Build/Products/Debug-iphonesimulator',
                stdio: 'inherit',
            });
    ...
    describe('xcrunLaunch', () => {
        it('launches the app with default config', async () => {
            ...
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'ignore', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(3, 'xcrun simctl launch iPhone\\ 13\\ Pro bundleId', {
                cwd: '/Users/johndoe/Projects/my-project/ios/build/Build/Products/Debug-iphonesimulator',
                stdio: 'ignore',
            });
        });
    ...
    describe('xcrunUi', () => {
        it('sets the simulator UI with default config', async () => {
            ...
            expect(execMock).toHaveBeenCalledTimes(3);
            expect(execMock).toHaveBeenNthCalledWith(1, 'xcrun simctl boot iPhone\\ 13\\ Pro', { stdio: 'ignore', reject: false });
            expect(execMock).toHaveBeenNthCalledWith(2, 'xcrun simctl ui iPhone\\ 13\\ Pro appearance dark', {
                cwd: '/Users/johndoe/Projects/my-project/ios/build/Build/Products/Debug-iphonesimulator',
                stdio: 'ignore',
            });
            expect(execMock).toHaveBeenNthCalledWith(3, 'xcrun simctl ui iPhone\\ 13\\ Pro appearance light', {
                cwd: '/Users/johndoe/Projects/my-project/ios/build/Build/Products/Debug-iphonesimulator',
                stdio: 'ignore',
            });
        });
