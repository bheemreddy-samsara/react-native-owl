...
exports.buildHandler = exports.buildAndroid = exports.buildIOS = exports.resolveEntryFile = exports.ENTRY_FILE = void 0;
...
const resolveEntryFile = (cwd = process.cwd()) => {
    if (process.env.OWL_ENTRY_FILE) {
        return path_1.default.resolve(cwd, process.env.OWL_ENTRY_FILE);
    }
    const candidates = [exports.ENTRY_FILE, ...FALLBACK_ENTRY_FILES].map((candidate) => path_1.default.resolve(cwd, candidate));
    for (const candidate of candidates) {
        if ((0, fs_1.existsSync)(candidate)) {
            return candidate;
        }
    }
    return path_1.default.resolve(cwd, exports.ENTRY_FILE);
};
...
const buildIOS = async (config, logger) => {
    ...
    await execa_1.default.command(buildCommand.join(' '), {
        stdio: 'inherit',
        env: {
            ENTRY_FILE: (0, exports.resolveEntryFile)(),
        },
    });
};
