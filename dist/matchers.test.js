...
describe('matchers.ts', () => {
    const mockedPixelmatch = jest.mocked(pixelmatch_1.default, { shallow: true });
    ...
    const mkdirSyncMock = jest.spyOn(fs_1.default, 'mkdirSync').mockImplementation();
    const readFileMock = jest.spyOn(fs_1.default, 'readFileSync');
    const writeFileMock = jest.spyOn(fs_1.default, 'writeFileSync');
    beforeAll(() => {
    ...
    describe('toMatchBaseline.ts', () => {
        ...
        it('should compare two identical images', () => {
            ...
            const result = (0, matchers_1.toMatchBaseline)(latestPath);
